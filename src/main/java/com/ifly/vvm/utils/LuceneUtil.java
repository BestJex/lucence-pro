...
public class LuceneUtil {
     ...
     * 
     * { Formatter formatter = new SimpleHTMLFormatter("<span style='color:red'>",
     * "</span>"); Scorer fragmentScorer = new QueryTermScorer(query, fieldName);
     * Highlighter highlighter = new Highlighter(formatter, fragmentScorer);
     * highlighter.setTextFragmenter(new SimpleFragmenter(200)); return highlighter;
     * }
     */
}
